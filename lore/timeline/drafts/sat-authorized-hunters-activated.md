# Sat — Authorized Hunters Activated (phase live)

```text
AUTHORIZED HUNTERS ACTIVATED
...
Those who held Standing enter first.
The Path is taking form on-chain.
...
```text
AUTHORIZED HUNTER ACCESS: LIVE

Activation has begun.
Authorized Hunters step through now.
