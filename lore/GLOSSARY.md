...
Quick reference. Full detail lives in the linked files.

| Term | Short meaning | File |
|------|---------------|------|
| **The Chain** | Invisible agreement that let civilization function — promises, trade, trust, alliances, sacrifice | `world/the-chain.md` |
| **The Severing** | The Chain was not destroyed; it was severed. Trust itself was manipulated | `world/the-severing.md` |
...
| **The Map** | What recovered Fragments actually rebuild — not the Chain itself | `arc/the-ending.md` |
| **Activation / Mint** | Gravemint.io mint = Activation; minted HoodLynx = recognized Hunter | `arc/the-ending.md` |
| **The Code** | Mentioned as something the Broken abandoned — **undefined** | `OPEN_QUESTIONS.md` |
| **The Hood** | Mentioned as the larger culture/order containing Keepers — **undefined** | `OPEN_QUESTIONS.md` |
| **The Pride** | Mentioned as consulting Keepers — **undefined** | `OPEN_QUESTIONS.md` |
